...
public class img3 extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener  {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        Intent intent =new Intent(img3.this,MainActivity.class);
