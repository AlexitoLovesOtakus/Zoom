...
public class img2 extends AppCompatActivity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        Intent intent =new Intent(img2.this,img3.class);
